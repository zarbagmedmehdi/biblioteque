...
if(Sessions.getAttribut("tab")!=null) {tabPane.getSelectionModel().select(1);
    Sessions.delete("tab");}
    ...
    public void populateetudTable(int val,String cn,String curs) throws SQLException {
        EmpHelper = FXCollections.observableArrayList(EtudiantService2.parseList(EtudiantService2.getEtudiant(val, cn, curs)));
    ...
    public void modifier(ActionEvent actionEvent) throws IOException {
        ...
        Main.forward(actionEvent, "../view/administrateur/etudInfoItem.fxml", this.getClass());
    }
    ...
    public void supprimer(ActionEvent actionEvent) throws SQLException, MessagingException {
        ...
        if( selectedItem!=null) {
            if(AlertUtil.showConfirmation("Supprresion","Vous voulez vraiment supprimer? ")){
               if(EtudiantService2.deleteEtudiant(selectedItem.getCne())==1)
    ...
    public void creer(ActionEvent actionEvent) throws SQLException, MessagingException {
        ...
        if(is==false){
           int val= EtudiantService2.createEtudiant( nomField.getText(),
